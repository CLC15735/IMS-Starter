...
public class OrderControllerTest {
	...
	public void testReadAll() {
		...
		INAME.add("Ball");
		final List <Float> PRICE = new ArrayList<>();
		PRICE.add(23.4f);

		orders.add(new Order(1L,"jordan", INAME, PRICE));
	...
	public void testUpdate() {
		...
		Order updated = new Order(1L ,1L, ITEM_ID);
		...
		Mockito.when(this.utils.getString()).thenReturn("no");
